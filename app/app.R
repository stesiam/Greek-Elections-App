...
ui <- add_cookie_handlers(
  div(
    tags$head(
      ...
      tags$title("Greek Elections App"),
      usei18n(i18n),
        ...
        div(class = "flex-none gap-x-3",
            tags$div(
              ...
              tags$select(
                ...
                class = "w-full max-w-xs border rounded px-3 py-2", # Tailwind classes for styling
                tags$option(disabled = NA, selected = NA, i18n$t("Choose a language")),
                tags$option(value = "en", "English (en)"),
                tags$option(value = "el", "Ελληνικά (el)")
              )
            )
        )
    ),
    div(class = "wrapper flex flex-col md:flex-row gap-4 md:gap-0 justify-center p-3",
        div(class = "card bg-base-100 max-w-md mx-auto p-4 rounded-2x shadow",
            div(class = "card-title text-center text-lg font-semibold mb-2",
                i18n$t("Choose Electoral System: ")
            ),
        ...
        column(width = 12,  
               div(class = "card flex justify-center max-w-2xl bg-base-100",
                   tags$div(
                     ...
                     tags$i(class = "fa-solid fa-landmark-flag text-2xl text-red-600"),  # FontAwesome icon
                   ...
                   tags$table(class="table table-zebra d-flex",
                              ...
                              tags$tbody(
                                ...
                                tags$tr(
                                  ...
                                  tags$th(tags$input(id = "pasok_pct", value =12.8, type="text", placeholder="Type here", class="input input-bordered w-full max-w-xs")),
    ...
    tags$footer(
      ...
      tags$div(class = "flex flex-row justify-center align-center", 
               tags$p(
                 "Copyright ©", 
                 tags$a(class = "link link-primary", href = "https://stesiam.com/", target = "_blank", "stesiam"),
                 ", 2024"
               )
      )
    )
...
server <- function(input, output, session) {
            ...
            chartOptions = list(
              series = list(
                dataLabels = list(
                  ...
                  style = list(
                    fontSize = "11px",
                    textOutline = "4px contrast",  # Outline for labels
                    colorOutline = "#000000"
                  )
                ),
              ...
              series = list(
                dataLabels = list(
                  ...
                  style = list(
                    ...
                    textOutline = "4px contrast", # Maintain outline 
                    colorOutline = "#000000"
                  )
                ),
  ...
  output$myButton <- downloadHandler(
    ...
    content = function(file) {
      ...
      tempReport <- file.path(tempdir(), "k.Rmd")
      file.copy("k.Rmd", tempReport, overwrite = TRUE)
